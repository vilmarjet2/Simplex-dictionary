...
public class PlotGraph extends JPanel {
	...
	public void setNewGraph(ArrayList<Double> _vecX, ArrayList<Double> _vecY, ArrayList<Double> _rhVal, final int m,
			final int n, double Obx11, double Oby11) {
...
class DrawingPanel2 extends JPanel {
	...
	private void color_FeaseableRegion(Graphics g) {
		...
		// 2nd ---- Set white in regions that are not the feeasible (It depend on the
		// constraint)
	...
	private void Calcul_XandY(double ax, double ay, double b, int idx) {
		...
		// System.out.println("maxY = " + maxY + ", SizeMaxY = " + SizeMaxY + ", (b/ay)
		// = " + (b/ay));
		...
		// System.out.println("bEFORE x1,y1 = (" + x1 + "," + y1 + ")" + "x2,y2 = (" +
		// x2 + "," + y2 + ")");
	}
	 ...
	 * Dimension size = this.getSize(); g.setColor (Color.red);
	 * 
	 * double a = 0.5, b = 0.75; int x1 = (int)X; int y1 = ;
	 * 
	 * int x2 = 0; int y2 = -(int)Y;
	 * 
	 * g.drawLine (x1, y1, x2, y2); }
	 */
